...
def montar_bloco_reserva(
    ...
    <div style="background:#0f172a;border:1px solid #f2a900;border-radius:14px;padding:18px;margin-top:16px;color:#e5e7eb;">
      ...
      <p style="margin:8px 0;"><strong style="color:#ffffff;">Data:</strong> {escape(str(data_inicio or "Não informado"))} às {escape(str(hora_inicio or "Não informado"))} até {escape(str(data_fim or data_inicio or "Não informado"))} às {escape(str(hora_fim or "Não informado"))}</p>
