...
function DashboardDesktop({ sair }) {
  ...
  const [tela, setTela] = useState(() =>
    obterTelaInicialDashboard(isAdmin, isAdmin ? "dashboard" : "salas")
  )
  ...
  useEffect(() => {
    if (!isAdmin && (tela === "dashboard" || tela === "admin")) {
      setTela("salas")
      setAdminTela("resumo")
      atualizarParametroDashboard("salas")
    }
  }, [isAdmin, tela])
  ...
  function irParaDashboard() {
    ...
    setTela("dashboard")
    atualizarParametroDashboard("dashboard")
    fecharPaineisFlutuantes()
  }
  ...
  function abrirResultado(resultado) {
    if (resultado.destino === "admin-problemas") {
      ...
      selecionarTela(resultado.destino)
    }
        ...
        <div className="mobile-instituicao-campi-list">
          {grupo.campi.map((campus) => {
            ...
            return (
              ...
              >
                <section className="campus-sidebar-main" aria-label={`Campus ${nomeCampus}`}>
                  <span className="campus-sidebar-info">
                  ...
                  <button
                    type="button"
                    className={`campus-sidebar-status ${statusCampus.ativo ? "online" : "offline"}`}
                    onClick={() => {
